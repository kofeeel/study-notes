...
❓ Selector
    └── ❓ Selector [🛡️IsAlive(Self)]
        ...
        └── ❓ Selector [🛡️IsAlive(Target)]
            ...
            │   │   └── ➡️ Sequence [🛡️CheckStance(M_HunchbackA_StandbySitting)]
            │   │       ├── ⚔️ UseSkill(StandbyToNormal combo=TableCommand)
            │   │       └── 📋 Blackboard(BattleStart)
            │   └── ➡️ Sequence [🛡️Blackboard(BattleStart) && 🛡️CheckActorEffect(Self.M_Common_SpawnEvent) && 🛡️CheckStance(NOT M_HunchbackA_StandbySitting)]
            │       ├── 📋 Blackboard(BattleStart)
