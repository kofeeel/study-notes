    ...
    └── ❓ Selector [🛡️IsAlive(Self)]
        ...
        └── ❓ Selector [🛡️IsAlive(Target)]
            ...
            └── ❓ Selector [🛡️AggroLevel(AIAggroLevel_Peaceful) && 🛡️CheckActorEffect(Target.Check_LinkWait)]
                ...
                │   └── 📋 Blackboard(BB1)
                ├── ➡️ Sequence
                │   ├── ⚔️ UseSkill(Reload) [🛡️DistanceToTarget(dist>=800.0) && 🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyA ON) && 🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyB ON)]
                │   └── ⏳ WaitTimeRandom
                ├── ❓ Selector
                │   ├── ➡️ Sequence
                ...
                │   │   └── ⏳ WaitTimeRandom
                │   └── ➡️ Sequence
                │       ├── ⚔️ UseSkill(Reload) [🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyA ON) && 🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyB ON)]
                │       └── ⏳ WaitTimeRandom
                ├── ❓ Selector
                │   ├── ❓ Selector [🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyA)]
                │   │   ├── ➡️ Sequence
                ...
                │   │       └── ⏳ WaitTimeRandom
                │   └── ❓ Selector [🛡️CheckActorEffect(Self.M_StatueD_Socket_EmptyB)]
                │       ├── ➡️ Sequence
